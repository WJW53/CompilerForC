...
isHasVarID::=FuncVarID ,@,
ExecuteStce::=DataProcessStce@ControlStce@CompoundStce
DataProcessStce::=AssignStce@FunctionCallStce@UnaryExprStce
...
NormalStce::=ExecuteStce@ValueDeclaration@PrintfStce@ScanfStce
IFStce::=if ( Expression ) NormalStce IFStce1
IFStce1::=else NormalStce@ε
